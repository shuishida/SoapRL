    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                actions, values, log_prob, new_options, new_option_probs = self.policy(curr_obs, self._last_options, episode_starts)
            ...
            rollout_buffer.add(curr_obs, next_obs, actions, rewards, episode_starts, dones, terminals,
                               values, log_prob, self._last_options, new_options, new_option_probs,
                               next_value=next_values, next_option=next_options, next_option_prob=next_option_probs)
            self._last_obs = new_obs  # type: ignore[assignment]
            self._last_episode_starts = dones
            self._last_options = new_options
